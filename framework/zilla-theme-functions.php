...
if ( !function_exists( 'zilla_custom_login_logo' ) ) {
	function zilla_custom_login_logo() {
	    ...
	    body, html { background: #22313f !important; }
	    body { margin-bottom: 3em; }
	        #login h1 a { background-image:url('.get_template_directory_uri().'/images/admin-login-logo.png) !important; background-size: 188px 67px !important; width: 188px !important;margin:0;padding:0; }
	    }
	    }
	    </style>';
	}
